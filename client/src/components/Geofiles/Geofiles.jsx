...
const Geofiles = () => {
  ...
  const CreateGeofileForm = () => {
    ...
    const validateForm = () => {
      const newErrors = {};
      if (!formData.name.trim()) newErrors.name = 'Name/Label is required';
      if (!selectedFile) newErrors.file = 'Please upload a geofile';
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        formDataToSend.append('coordinateSystem', formData.coordinateSystem);
        ...
        if (formData.obId) formDataToSend.append('obId', formData.obId);
        if (formData.evidenceId) formDataToSend.append('evidenceId', formData.evidenceId);
